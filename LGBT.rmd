...
Based on the results 23% of people got aids. The drugs are working effectively. The Fisher test proves this statement, which says that it decreases the chances that you get aids if you use the drug if you are apart of the LGBT community.
