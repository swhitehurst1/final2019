...
Based on the results 60% of people got aids. This means the drugs aren't working. The Fisher test proves this statement, which says that it improves the chances that you get aids if you use the drug.